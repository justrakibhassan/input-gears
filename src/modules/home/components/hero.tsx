        ...
        {slides.length > 1 && (
          <>
            <button
              ...
              className="absolute left-4 top-1/2 -translate-y-1/2 z-20 p-3 bg-white/30 text-white rounded-full hover:bg-white/50 backdrop-blur-md hidden md:block transition-all hover:scale-105 active:scale-95"
            ...
            <button
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 z-20 p-3 bg-white/30 text-white rounded-full hover:bg-white/50 backdrop-blur-md hidden md:block transition-all hover:scale-105 active:scale-95"
