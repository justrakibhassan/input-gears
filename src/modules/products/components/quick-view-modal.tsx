...
export interface QuickViewProduct {
  ...
  colors?: string[];
  specs?: Record<string, string | number | boolean | null | unknown> | null;
...
const QuickViewModalInner: React.FC<QuickViewModalInnerProps> = ({
  product,
  onClose,
}) => {
  ...
  const handleToggleCompare = (e: React.MouseEvent) => {
    ...
    if (isComparing) {
      ...
      compare.addItem({
        ...
        specs: (product.specs as Record<string, string | number | boolean | null>) || null,
        brand: product.brand,
        sku: product.sku,
        dpi: product.dpi,
    ...
    >
      ...
      <div className="w-full md:w-[52%] p-4 sm:p-6 flex flex-col justify-between overflow-y-auto no-scrollbar bg-white">
        <div className="space-y-3">
          {/* Header: Category & Stock Status Pill */}
